...
function edit_pages_form()
{
    if (isset($_REQUEST['id'])) {
        ...
        $pagesshandler = xoops_getModuleHandler('pages', 'lawsuit');
    ...
    $form->addElement(new LawsuitFormSelectCategory(_AM_PAGE_CAT, 'cid', $cid, 1, false));

    $form->addElement(new LawsuitFormSelectForms(_AM_PAGE_FORMS, 'form_id', $form_id, 1, false));

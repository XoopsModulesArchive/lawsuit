...
$modversion['config'][5]['options'] = [_MI_LAWSUIT_MOREINFO_USER => 'user', _MI_LAWSUIT_MOREINFO_IP => 'ip', _MI_LAWSUIT_MOREINFO_AGENT => 'agent', _MI_LAWSUIT_MOREINFO_FORM => 'form'];
...
$modversion['config'][11]['default'] = XOOPS_UPLOAD_PATH . '/' . uniqid(mt_rand());

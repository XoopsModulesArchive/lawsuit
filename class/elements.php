...
class LawsuitElements extends XoopsObject
{
...
class LawsuitElementsHandler
{
    public $db;

    public $db_table;

    public $obj_class = 'LawsuitElements';

    public function __construct($db)
    {
        $this->db = $db;

        $this->db_table = $this->db->prefix('lawsuit_formelements');
    }
    ...
    public function insertDefaults($form_id)
    {
        ...
        include LAWSUIT_ROOT_PATH . 'admin/default_elements.php';

...
// $Id: about.php,v 1.05 2009/06/24 23:45:00 wishcraft Exp $

require __DIR__ . '/admin_header.php';
xoops_cp_header();
?>
    <img src="../images/lawsuite_slogo.png" alt="Lawsuit" style="float: left; margin: 0 10px 5px 0;">
    <h4 style="margin: 0;">Lawsuit</h4>
    ...
    <p style="margin: 0;">
        Lawsuit is Freeware and Opensource. If you think it is useful and would like to show your appreciation, you can support us in one of the following ways:
    </p>
    <ul>
        <li><a href="https://www.paypal.com/xclick/business=sales%40chronolabs.org.au&item_name=Donation+for+Chronolabds+Freewares&item_number=lawsuit&no_note=1&tax=0&currency_code=AUD">Donate us via PayPal</a>
        </li>

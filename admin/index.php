...
switch ($op) {
            ...
            foreach ($forms as $f) {
                ...
                echo '
					<tr>
						...
						<td class="odd"><ul>
							<li><a href="' . LAWSUIT_ADMIN_URL . '?op=edit&amp;form_id=' . $id . '">' . _AM_FORM_ACTION_EDITFORM . '</a></li>
							<li><a href="elements.php?form_id=' . $id . '">' . _AM_FORM_ACTION_EDITELEMENT . '</a></li>
							<li><a href="' . LAWSUIT_ADMIN_URL . '?op=edit&amp;clone=1&amp;form_id=' . $id . '">' . _AM_FORM_ACTION_CLONE . '</a></li>
							<li><a href="' . LAWSUIT_ADMIN_URL . '?op=delete&amp;form_id=' . $id . '">' . _DELETE . '</a></li>
						</ul>' . $ids->render() . '</td>
					</tr>';
            }
    ...
    case 'edit':
        ...
        $group_ids = &$lawsuit_form_mgr->permHandler->getGroupIds($lawsuit_form_mgr->perm_name, $form_id, $xoopsModule->getVar('mid'));
    ...
    case 'delete':
        if (empty($_POST['ok'])) {
            ...
            xoops_confirm(['op' => 'delete', 'form_id' => $_GET['form_id'], 'ok' => 1], LAWSUIT_ADMIN_URL, _AM_FORM_CONFIRM_DELETE);
        } else {
